...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btAlertaSimple.setOnClickListener {  showSimpleAlertDialog() }
        binding.btOkCancelar.setOnClickListener {  showOkCancelAlertDialog() }
        binding.btOkNoCancelar.setOnClickListener { showOkNoCancelAlertDialog() }
        binding.btListaAlerta.setOnClickListener { showListAlertDialog() }
        binding.btSoloChoiceAlerta.setOnClickListener { showSingleChoiceAlertDialog() }
        binding.btMultiChoiceAlerta.setOnClickListener { showMultiChoiceAlertDialog() }
        binding.btCustomAlerta.setOnClickListener { showCustomInputAlertDialog() }
